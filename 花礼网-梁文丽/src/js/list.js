(function () {
    ...
    filterbar.onclick = function (ev) {
        if (ev.target.className == 'xiaoliang') {
            ...
            let prestr33 = `SELECT *FROM lgood ORDER BY shou DESC LIMIT 0,5;`;
            getdata(url33, prestr33, res => {
            ...
            // let prestr34 = `SELECT *FROM lgood ORDER BY shou DESC LIMIT LIMIT 5,72;`;
            // getdata(url33, prestr34, res1 => {
            //     let pre1 = JSON.parse(res1);
            //     // console.log(pre1);
            //     let str1 = '';
            //     for (let i = 0; i <= 13; i++) {
            //         str1 += `
